...
const projectData = [
  { name: 'Victoria Gardens', collected: 8500000, outstanding: 3200000, overdue: 1200000, target: 12000000 },
  { name: 'Emerald Heights', collected: 6200000, outstanding: 4800000, overdue: 800000, target: 11000000 },
  { name: 'Golden View', collected: 9100000, outstanding: 2100000, overdue: 400000, target: 11500000 },
  { name: 'Sunset Heights', collected: 4300000, outstanding: 5600000, overdue: 1800000, target: 10000000 }
];
...
export function EnhancedMonitoringDashboard() {
  ...
  const totalTarget = projectData.reduce((sum, project) => sum + Number(project.target), 0);
  ...
  const avgEfficiency = collectionEfficiency.reduce((sum, item) => sum + item.efficiency, 0) / collectionEfficiency.length;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Comprehensive insights into fee collection performance</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs text-green-600">+2.5% vs target</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs text-green-600">Across all projects</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs text-purple-600">YTD performance</span>
                </div>
              </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Select value={selectedMetric} onValueChange={setSelectedMetric}>
                ...
                <SelectContent>
                  <SelectItem value="collection-rate">Collection Rate</SelectItem>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <PieChart>
                ...
                <Tooltip formatter={(value, name, props) => [`${value}%`, `₦${(props.payload.amount / 1000000).toFixed(1)}M`]} />
              </PieChart>
            </ResponsiveContainer>
            <div className="mt-4 space-y-2">
              {feeTypeData.map((entry, index) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">₦{(entry.amount / 1000000).toFixed(1)}M</span>
                </div>
              ))}
            </div>
          </CardContent>
            ...
            {collectionEfficiency.map((project, index) => (
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500">Target: {project.target}%</span>
                    <Badge className={project.efficiency >= project.target ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}>
                      {project.efficiency}%
                    </Badge>
                  </div>
                </div>
