...
import { Plus, TrendingUp, Users, DollarSign, Eye, Edit, Trash2, Clock, CheckCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage marketers and track commissions</p>
        </div>
