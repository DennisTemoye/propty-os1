...
const mockClientDocuments: Document[] = [
  ...
  },
  {
    ...
    size: '245 KB',
    uploadDate: '2024-01-10',
    description: 'Client passport photograph',
    status: 'approved',
    category: 'KYC'
  },
  {
    id: 3,
    name: 'Allocation Letter.pdf',
    type: 'PDF',
    size: '980 KB',
    uploadDate: '2024-01-15',
    description: 'Property allocation letter',
    status: 'approved',
    category: 'Property'
  }
];
...
export function ClientDocumentsView({ client }: ClientDocumentsViewProps) {
      ...
      <Dialog open={isAddDocumentOpen} onOpenChange={setIsAddDocumentOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new document for {client.name}
            </DialogDescription>
          </DialogHeader>
