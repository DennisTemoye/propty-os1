    ...
    <>
      <div className="relative">
        ...
        <Button
          ...
          className="absolute top-0 right-0 z-10 h-8 w-8 p-0"
        >
          <X className="h-4 w-4" />
        </Button>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="developmentStage" className="text-left block">Development Stage *</Label>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="location" className="text-left block">Full Address</Label>
                <Input
                  id="location"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="type" className="text-left block">Project Type</Label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="totalBlocks" className="text-left block">Total Blocks</Label>
                  <Input
                    id="totalBlocks"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="totalUnits" className="text-left block">Total Units</Label>
                  <Input
                    id="totalUnits"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="budget" className="text-left block">Budget</Label>
                  <Input
                    id="budget"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="startDate" className="text-left block">Start Date</Label>
                  <Input
                    id="startDate"
                    type="date"
                ...
                <div className="space-y-2">
                  <Label htmlFor="expectedCompletion" className="text-left block">Expected Completion</Label>
                  <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="projectManager" className="text-left block">Project Manager</Label>
                  <Input
                    id="projectManager"
                ...
                <div className="space-y-2">
                  <Label htmlFor="tags" className="text-left block">Tags (comma separated)</Label>
                  <Input
                    id="tags"
                    value={formData.tags}
