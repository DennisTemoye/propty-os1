...
const mockProjects = [
  { id: 'project1', name: 'Victoria Gardens', status: 'active' },
  { id: 'project2', name: 'Emerald Heights', status: 'pre-launch' },
  { id: 'project3', name: 'Golden View', status: 'active' },
  { id: 'project4', name: 'Ocean Breeze', status: 'development' }
];
...
export function SalesFlowModal({ isOpen, onClose, onSubmit }: SalesFlowModalProps) {
  const form = useForm({
    defaultValues: {
      clientId: '',
      projectId: '',
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Document a property sale transaction. Choose the sales type based on allocation readiness.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                    ...
                    <SelectItem key={project.id} value={project.id}>
                      <div className="flex items-center justify-between w-full">
                        ...
                        <span className={`text-xs px-2 py-1 rounded ${
                          ...
                          project.status === 'pre-launch' ? 'bg-blue-100 text-blue-700' :
          ...
          <div>
            ...
            <Select onValueChange={(value) => form.setValue('salesType', value)}>
              <SelectTrigger>
