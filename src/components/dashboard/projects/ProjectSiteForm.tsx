...
import { MapPin, Building2, Layers, Info, Plus, Trash2, FileText, X } from 'lucide-react';
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-left block">Development Name *</FormLabel>
                            <FormControl>
                              <Input 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-left block">Location *</FormLabel>
                            <FormControl>
                              <Input 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-left block">Development Description</FormLabel>
                          <FormControl>
                            <Textarea 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-left block">Document Title</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-left block">Development Type *</FormLabel>
                            <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-left block">Development Status</FormLabel>
                            <FormControl>
                              <Select onValueChange={(value) => {
                                field.onChange(value);
                                setHasUnsavedChanges(true);
