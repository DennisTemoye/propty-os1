...
const advancedToolsItems = [
  {
    icon: TrendingUp,
    label: "CRM Pipelines",
    path: "/company/tools/crm-pipelines",
  },
  {
    icon: FolderOpen,
    label: "Document Manager",
    path: "/company/tools/document-manager",
  },
  {
    icon: Calendar,
    label: "Calendar & Scheduling",
    path: "/company/tools/calendar",
  },
  { icon: Send, label: "Send Notice", path: "/company/tools/send-notice" },
  { icon: Wrench, label: "API Test", path: "/company/tools/advanced-test" },
];
      ...
      <>
        ...
        >
          ...
          <div className="px-3 py-2">
            <Badge
              variant="outline"
              className="text-xs border-blue-300 text-blue-200 bg-blue-900/30"
            >
              Built for Africa
            </Badge>
          </div>
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isActivePath(item.path) &&
                      "bg-blue-700 text-white shadow-lg ring-2 ring-blue-400/50"
                  )}
