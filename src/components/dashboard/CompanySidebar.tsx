...
export function CompanySidebar({ className }: CompanySidebarProps) {
  ...
  return (
    <div className={cn('pb-12 w-64 bg-gradient-to-b from-purple-900 via-purple-800 to-purple-900', className)}>
      <div className="space-y-4 py-4">
        <div className="px-3 py-2">
          ...
          <div className="flex items-center text-sm text-purple-200">
            <Badge variant="outline" className="text-xs border-purple-300 text-purple-200">
              Real Estate CRM
            </Badge>
          </div>
        </div>
        <div className="px-3">
          <ScrollArea className="h-[calc(100vh-160px)]">
            <div className="space-y-1">
              {sidebarItems.map((item) => (
                <Button
                  ...
                  className={cn(
                    'w-full justify-start text-purple-100 hover:text-white hover:bg-purple-700/50',
                    isActivePath(item.path) && 'bg-purple-600 text-white hover:bg-purple-600'
                  )}
              ...
              >
                <CollapsibleTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-between text-purple-100 hover:text-white hover:bg-purple-700/50',
                      isAdvancedToolsActive() && 'bg-purple-600 text-white hover:bg-purple-600'
                    )}
                  >
                ...
                <CollapsibleContent className="space-y-1 mt-1">
                  {advancedToolsItems.map((item) => (
                    <Button
                      ...
                      variant={isActivePath(item.path) ? 'secondary' : 'ghost'}
                      className={cn(
                        'w-full justify-start pl-8 text-sm text-purple-200 hover:text-white hover:bg-purple-700/50',
                        isActivePath(item.path) && 'bg-purple-600 text-white hover:bg-purple-600'
                      )}
                      onClick={() => navigate(item.path)}
                    >
              ...
              <Button 
                variant="ghost" 
                className="w-full justify-start text-purple-100 hover:text-white hover:bg-purple-700/50" 
            ...
            <div className="mt-8 pt-4 border-t border-purple-700">
              <div className="space-y-1">
                <Button 
                  variant="ghost" 
                  className="w-full justify-start text-purple-100 hover:text-white hover:bg-purple-700/50" 
