...
export default function MarketersCommission() {
  ...
  const onUpdateMarketer = (data: any) => {
    setMarketers(
      marketers.map((marketer) =>
        marketer.id === editMarketer.id ? { ...marketer, ...data } : marketer
      )
    );
  ...
  const totalCommission = marketers.reduce(
    (sum, m) =>
      sum + parseFloat(m.commission.replace("₦", "").replace("M", "")),
    0
  );
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage marketers and track commissions
          </p>
        </div>
        <Button
          onClick={() => setIsAddMarketerOpen(true)}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex space-x-2 pt-3">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => setViewMarketer(marketer)}
                      >
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {commission.project} • {commission.client}
                        </div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">
                          {commission.commissionRate} of {commission.saleAmount}
                        </div>
                      </div>
      ...
      <Dialog open={isAddMarketerOpen} onOpenChange={setIsAddMarketerOpen}>
        <DialogContent>
          ...
          <form
            onSubmit={form.handleSubmit(onSubmitMarketer)}
            className="space-y-4"
          >
            <div>
            ...
            <div>
              ...
              <Textarea
                {...form.register("bio")}
                placeholder="Marketer bio and specialization..."
              />
            </div>
            <div className="flex gap-2">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={() => setIsAddMarketerOpen(false)}
              >
                Cancel
              </Button>
            </div>
      ...
      <Dialog open={!!editMarketer} onOpenChange={() => setEditMarketer(null)}>
        <DialogContent>
          ...
          <form
            onSubmit={form.handleSubmit(onUpdateMarketer)}
            className="space-y-4"
          >
            <div>
              <label className="text-sm font-medium">Full Name</label>
      ...
      <Dialog open={!!viewMarketer} onOpenChange={() => setViewMarketer(null)}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Marketer details and performance
            </DialogDescription>
          </DialogHeader>
          {viewMarketer && (
            <div className="space-y-4">
